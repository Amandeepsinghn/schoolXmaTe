...
const testGeneration = async (subject, title) => {
  headers = {
  ...
  data = {
    ...
    messages: [
      ...
      },
      {
        role: "user",
        content: `
        Create a multiple-choice test on the subject of ${subject}, focusing specifically on ${title}. Generate exactly 10 questions. Each question should have:
